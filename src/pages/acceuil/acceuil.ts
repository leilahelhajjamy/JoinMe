...
export class AcceuilPage {
    ...
    Locations =[];
    TopEvents=[];
  constructor( public eventProvider :EventProvider,public locationProvider :LocationProvider ,public afSG: AngularFireStorage, public modalCtrl: ModalController,public likesProvider :LikesProvider ,private storage: Storage,public modalController: ModalController,public authProvider :AuthProvider,public userProvider :UserProvider,public nav :Nav,public fire: AngularFireAuth,public formBuilder : FormBuilder,public navCtrl: NavController,afDB: AngularFireDatabase,  
